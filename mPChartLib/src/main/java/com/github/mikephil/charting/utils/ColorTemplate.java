...
public class ColorTemplate {
	...
	// Color.rgb(192, 255, 140), Color.rgb(255, 247, 140), Color.rgb(255, 208,
	// 140),
	// Color.rgb(140, 234, 255), Color.rgb(255, 140, 157)
	// };

	public static final int[] VORDIPLOM_COLORS = { Color.rgb(245, 116, 47),
			Color.rgb(109, 245, 47), Color.rgb(183, 47, 245),
			Color.rgb(47, 222, 245), Color.rgb(73, 47, 245) };
